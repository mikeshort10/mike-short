        ...
        <Card.Body>
          ...
          <FormGroup>
            <FormCheck type="radio"
              name="numOfEnemies"
              onChange={() => props.changeState("numOfEnemies", 6)}
              value={6}
              label="6"
            />
            <FormCheck type="radio"
              name="numOfEnemies"
              onChange={() => props.changeState("numOfEnemies", 12)}
              value={12}
            ...
            <FormCheck type="radio"
              name="numOfEnemies"
              onChange={() => props.changeState("numOfEnemies", 18)}
              value={18}
              label="18"
            />
          </FormGroup>
          ...
          <FormGroup>
            <FormCheck type="radio"
              name="enemyType"
              onChange={() => props.changeState("enemyType", "hufflepuff")}
              value="hufflepuff"
              checked={props.enemyType === "hufflepuff" ? "checked" : ""}
              label="Hufflepuff"
              />
            <FormCheck type="radio"
              name="enemyType"
              onChange={() => props.changeState("enemyType", "ravenclaw")}
              value="ravenclaw"
              label="Ravenclaw"
              />
            <FormCheck type="radio"
              name="enemyType"
              onChange={() => props.changeState("enemyType", "slytherin")}
              value="slytherin"
              label="Slytherin"
              />
          </FormGroup>
