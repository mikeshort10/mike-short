	...
	return (
        <div>
          ...
          className="text-center border-none">
            ...
            className="header">How To Play</Card.Header>
            <Card.Header style={{color: 'black', backgroundColor: 'white'}} 
            className="header-placeholder">H</Card.Header>
            <Card.Body>
              ...
              the classrooms. Find the counter-curse <i className="fas fa-book book" /> 
