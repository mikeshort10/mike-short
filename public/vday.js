		...
		let lovers = [
			{
				title: "Taker",
				description:
					"You are a selfish lover. You take a lot of lovin, \
			...
			},
			{
				title: "Little Spoon",
				description:
					"While you're not the most selfish lover, you still \
			...
			},
			{
				title: "Great Hugger",
				description:
					"You like a perfectly balanced relationship. You're \
			...
			},
			{
				title: "Big Spoon",
				description:
					"You might wake up with a dead arm and possibly lost \
			...
			},
			{
				title: "Giver",
				description:
					"You're someone who will express their love 1000 times, even \
	...
	function switchPicture() {
		$("#img").animate(
			...
			() => {
				...
				while (
					src === 4 ||
					`/love-bugs/lb${src}.jpg` === $("#img").attr("src")
				);
				$("#img")
					.attr("src", `/love-bugs/lb${src}.jpg`)
					.attr(
						"alt",
						`looks like image #${src} has a bug...but I still love you!`,
					)
					.animate(
						{
							opacity: 1,
